  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-heading font-bold tracking-tight">Audit Management</h1>
          <p className="text-muted-foreground mt-1">Enterprise management and configuration for Audit.</p>
        </div>
      ...
      <div className="border border-border rounded-xl bg-card shadow-sm flex flex-col">
        ...
        <div className="p-16 flex flex-col items-center justify-center text-center">
          ...
          <h3 className="text-lg font-semibold">No Audit found</h3>
